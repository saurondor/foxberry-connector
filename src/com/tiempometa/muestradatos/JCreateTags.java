		...
		try {
			...
			try {
				...
				JOptionPane.showMessageDialog(this,
						"Se generaron " + rfidList.size() + " tags",
	...
	private void initComponents() {
		...
		//======== dialogPane ========
		{
			...
			//======== contentPanel ========
			{
				...
				useBibAsValueCheckBox.setText(bundle.getString("JCreateTags.useBibAsValueCheckBox.text"));
				contentPanel.add(useBibAsValueCheckBox, cc.xy(5, 7));

				//---- createButton ----
				createButton.setText(bundle.getString("JCreateTags.createButton.text"));
